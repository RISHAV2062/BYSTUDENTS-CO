...
<style>
    ...
    * {
    ...
    .glass-card:hover {
        ...
        box-shadow: 0 20px 40px -5px rgb(99 102 241 / 0.3);
    }
...
def show_landing_page():
    ...
    # Features - Use Streamlit columns instead of HTML
    st.markdown("""
    <div class='section-header'>
...
# Auth pages and dashboard (simplified versions)
...
def show_dashboard():
    with st.sidebar:
        ...
        <div style='text-align: center; padding: 2rem 1rem;'>
            ...
            <p style='color: var(--text-secondary); font-size: 0.9rem;'>Welcome back!</p>
        </div>
        """, unsafe_allow_html=True)
...
def show_dashboard_home():
    st.markdown(f"<h1 style='font-size: 2.5rem; font-weight: 800; color: var(--text-primary); margin: 2rem 0 1rem;'>Hi {st.session_state.user_data['name'].split()[0]} 👋</h1>", unsafe_allow_html=True)
    st.markdown("<p style='color: var(--text-secondary); font-size: 1.1rem; margin-bottom: 3rem;'>Let's get you into your dream college</p>", unsafe_allow_html=True)
    ...
    <div class='dashboard-grid'>
        <div class='metric-card-modern'>
            ...
            <div class='metric-value-modern'>{st.session_state.user_data['sat_score']}</div>
        </div>
        <div class='metric-card-modern'>
    ...
    with col1:
        ...
        st.markdown("<h3 style='color: var(--text-primary); font-size: 1.5rem; margin-bottom: 1.5rem;'>📋 Your Application Progress</h3>", unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("<div class='glass-card'>", unsafe_allow_html=True)
        st.markdown("<h3 style='color: var(--text-primary); font-size: 1.5rem; margin-bottom: 1.5rem;'>🎯 Quick Actions</h3>", unsafe_allow_html=True)
...
def show_essays():
        ...
        if not st.session_state.user_data['essays']:
            ...
            for idx, essay in enumerate(st.session_state.user_data['essays']):
                with st.expander(f"📄 {essay['title']}"):
                    ...
                    st.text_area("Content", essay['content'], height=200, disabled=True)
    ...
    with tabs[2]:
        ...
        with col1:
            ...
            if st.button("Purchase Editing", use_container_width=True):
                st.success("Service purchased!")
        ...
        with col2:
            ...
            if st.button("Purchase Full Support", use_container_width=True):
                st.success("Service purchased!")
